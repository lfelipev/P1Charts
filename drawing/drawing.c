...
void DrawerDrawLines(Drawer * self, Line line) {
	cairo_move_to (self->context, line.horizontal_x, line.horizontal_y);
	cairo_line_to (self->context, line.large_x, line.horizontal_y);

	cairo_move_to (self->context, (line.horizontal_x)*2, line.vertical_y);
	cairo_line_to (self->context, line.large_y, line.large_y2);

	cairo_set_line_width (self->context, line.width);
